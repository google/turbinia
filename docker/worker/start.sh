...
then
    poetry run python3 /home/turbinia/turbinia/turbiniactl.py $TURBINIA_EXTRA_ARGS -L $TURBINIA_LOG_FILE $WORKER &
else
    poetry run python3 /home/turbinia/turbinia/turbiniactl.py $TURBINIA_EXTRA_ARGS $WORKER &
fi
