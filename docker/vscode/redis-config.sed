...
s/DISABLED_JOBS = .*/DISABLED_JOBS = ['VolatilityJob', 'DockerContainersEnumerationJob', 'PhotorecJob','WindowsAccountAnalysisJob','WordpressCredsAnalysisJob','LinuxAccountAnalysisJob','HindsightJob','HadoopAnalysisJob']/g
