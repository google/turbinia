...
class Artifact(object):
  ...
  def __init__(self, name=None, description=None, local_path=None):
    ...
    # List of jobs that have processed this artifact
    self.processed_by = []
...
class RawDisk(Artifact):
  pass


class EncryptedDisk(Artifact):
  """Encrypted disk file artifact."""
...
class GoogleCloudDisk(Artifact):
...
class PlasoFile(Artifact):
  """Plaso output file artifact."""
