...
class TurbiniaRequestsApi(object):
  ...
  def create_request(self, request, **kwargs):
    """Create Request  # noqa: E501
        ...
        Create a new Turbinia request.  Args:   request (turbinia.api.schema.request): JSON object from the HTTP POST data       matching the schema defined for a Turbinia Request. The schema is used       by pydantic for field validation.  Raises:   ValidationError: if the Request object contains invalid data.  # noqa: E501
  ...
  def get_request_status(self, request_id, **kwargs):
    """Get Request Status  # noqa: E501
        ...
        Retrieves status for a Turbinia Request.  Args:   request_id (str): A Turbinia request identifier.  Raises:   HTTPException: if another exception is caught.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    kwargs['request_id'] = \
        request_id
    return self.get_request_status_endpoint.call_with_http_info(**kwargs)

  def get_requests_summary(self, **kwargs):
    ...
    kwargs['_host_index'] = kwargs.get('_host_index')
    kwargs['_request_auths'] = kwargs.get('_request_auths', None)
    return self.get_requests_summary_endpoint.call_with_http_info(**kwargs)
