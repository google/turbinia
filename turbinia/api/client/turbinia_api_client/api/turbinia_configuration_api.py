...
class TurbiniaConfigurationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_evidence_attributes_by_name_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'oAuth2'
                ],
                'endpoint_path': '/api/config/evidence/{evidence_name}',
                'operation_id': 'get_evidence_attributes_by_name',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_evidence_types_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'oAuth2'
                ],
                'endpoint_path': '/api/config/evidence',
                'operation_id': 'get_evidence_types',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_request_options_endpoint = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'oAuth2'
                ],
                'endpoint_path': '/api/config/request_options',
                'operation_id': 'get_request_options',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_evidence_attributes_by_name(
        self,
        evidence_name,
        **kwargs
    ):
        ...
        kwargs['evidence_name'] = \
            evidence_name
        return self.get_evidence_attributes_by_name_endpoint.call_with_http_info(**kwargs)
    ...
    def get_evidence_types(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_evidence_types_endpoint.call_with_http_info(**kwargs)
    ...
    def get_request_options(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_request_options_endpoint.call_with_http_info(**kwargs)
    ...
    def read_config(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.read_config_endpoint.call_with_http_info(**kwargs)
