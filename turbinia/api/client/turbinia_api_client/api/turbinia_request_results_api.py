...
class TurbiniaRequestResultsApi(object):
  ...
  def get_request_output(self, request_id, **kwargs):
    ...
    kwargs['request_id'] = \
        request_id
    return self.get_request_output_endpoint.call_with_http_info(**kwargs)

  def get_task_output(self, task_id, **kwargs):
    ...
    kwargs['task_id'] = \
        task_id
    return self.get_task_output_endpoint.call_with_http_info(**kwargs)
