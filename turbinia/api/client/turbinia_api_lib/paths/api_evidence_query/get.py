...
class AttributeNameSchema(
    ...
    def TASKS(cls):
        return cls("tasks")
AttributeValueSchema = schemas.StrSchema
...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'attribute_value': typing.Union[AttributeValueSchema, str, ],
    }
)
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        'attribute_name': typing.Union[AttributeNameSchema, str, ],
...
request_query_attribute_value = api_client.QueryParameter(
...
class QueryEvidence(BaseApi):
    ...
    def query_evidence(
        ...
        return self._query_evidence_oapg(
