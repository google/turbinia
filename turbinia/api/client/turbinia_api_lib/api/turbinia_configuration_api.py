...
class TurbiniaConfigurationApi:
    ...
    @validate_arguments
    def download_config(self, **kwargs) -> str:  # noqa: E501
        """Download Configuration  # noqa: E501

        Downloads the Turbinia configuration.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.download_config(async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the download_config_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.download_config_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def download_config_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Download Configuration  # noqa: E501
        ...
        >>> thread = api.download_config_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method download_config" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
