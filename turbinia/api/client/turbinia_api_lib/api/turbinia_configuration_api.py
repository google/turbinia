...
class TurbiniaConfigurationApi(object):
    ...
    @validate_arguments
    def get_evidence_attributes_by_name(self, evidence_name : Any, **kwargs) -> object:  # noqa: E501
        ...
        >>> thread = api.get_evidence_attributes_by_name(evidence_name, async_req=True)
        >>> result = thread.get()

        :param evidence_name: (required)
        :type evidence_name: object
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_evidence_attributes_by_name_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.get_evidence_attributes_by_name_with_http_info(evidence_name, **kwargs)  # noqa: E501

    @validate_arguments
    def get_evidence_attributes_by_name_with_http_info(self, evidence_name : Any, **kwargs) -> ApiResponse:  # noqa: E501
        """Get Evidence Attributes By Name  # noqa: E501
        ...
        >>> thread = api.get_evidence_attributes_by_name_with_http_info(evidence_name, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_evidence_attributes_by_name" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _path_params = {}
        if _params['evidence_name']:
            _path_params['evidence_name'] = _params['evidence_name']
        ...
        return self.api_client.call_api(
            '/api/config/evidence/{evidence_name}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
