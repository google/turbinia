...
class ApiClient:
  ...
  def __call_api(
      ...
      response_types_map=None, auth_settings=None, _return_http_data_only=None,
    ...
    if _preload_content or _return_http_data_only:
      ...
      if not response_type and isinstance(
          response_data.status, int) and 100 <= response_data.status <= 599:
    ...
    if _return_http_data_only:
      ...
      return ApiResponse(
          status_code=response_data.status, data=return_data,
          headers=response_data.getheaders(), raw_data=response_data.data)
